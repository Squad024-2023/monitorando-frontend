                ...
                <div className={styles.tela1}>
                    <Reveal delay={0.25}>
                        <div className={styles.textoTela1}>
                            ...
                            <p>Nosso objetivo principal são estudantes que não tiveram uma boa educação base do ensino médio e se deparam com grandes dificuldades nos seus primeiros meses de faculdade.
                            </p>
                            <Doar />
                        </div>
                    </Reveal>
